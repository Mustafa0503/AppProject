...
public class pfpForAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pfp_for_admin);
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(pfpForAdmin.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void mainActAdmin(View view){
        Intent b1 = new Intent(this, MainActivity2.class);
        startActivity(b1);
        finish();
    }
}